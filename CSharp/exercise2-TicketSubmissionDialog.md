...
1.  アプリを停止します。**Controllers** フォルダーで、このハンズオン ラボの fassets フォルダーの TicketsController.cs fをコピーします。これは、/api/tickets エンドポイントへの **POST** 要求を処理し、チケットをアレイに追加して、作成されたチケット ID を使用して応答します。
