...
4.  [Save] (![](media/71014e217047b256db857a7d15939f40.png)) をクリックします。
...
6.  [Deployment] セクションに移動して、左側のメニューにある [Deployment options]
...
2.  次に、次のコマンドを入力します。{gitcloneurl} の部分は、前のタスクで得られた
...
3.  以下のコマンドを入力して、変更内容をコミットし、Azure Web
    アプリにプッシュします。
...
5. 次に表示される画面で、ファイルがアップロードされ、リモート サーバー上に npm
...
4.  [Channels] メニュー項目をクリックします。**Skype** チャネルと **Web
